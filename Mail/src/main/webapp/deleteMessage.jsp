...
String sql ="SELECT * FROM message WHERE id='"+ee+"'";
...
PreparedStatement pst2 = con.prepareStatement("INSERT INTO `deletedmessage` (`id`, `sender`, `receiver`, `msg`, `date`) VALUES(?,?,?,?,?)");
pst2.setString(1,id);
...
pst.executeUpdate("DELETE FROM message WHERE id='"+ee+"'");
